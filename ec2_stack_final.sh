...
cd /var/www
sudo git clone "https://${GITHUB_USERNAME}:${GITHUB_PAT}@github.com/vndamodar/qapin_backend_v2.0.git"
...
cd /var/www
sudo git clone "https://${GITHUB_USERNAME}:${GITHUB_PAT}@github.com/vndamodar/node_1.O.git"
cd node_1.O
npm install
...
cd /var/www
sudo git clone "https://${GITHUB_USERNAME}:${GITHUB_PAT}@github.com/vndamodar/Vue-Latest.git"
cd Vue-Latest
npm install
npm run build
